...
export const relatedFoodGroups: RelatedFoodGroup[] = [
  { id: 'tuber', name: '薯类', foodIds: ['v_tudou', 'v_hongshu', 'v_shanyao', 'v_zishu', 'v_yutou', 'g_hongshufeng', 'g_tudounifen'] },
  { id: 'cruciferous_leaf', name: '十字花科绿叶', foodIds: ['v_xilanhua', 'v_bocai', 'v_baicai', 'v_shengcai', 'v_caihua', 'v_youcai', 'v_xiaobaicai', 'v_qingcai'] },
  { id: 'gourd', name: '瓜类蔬菜', foodIds: ['v_nangua', 'v_donggua', 'v_huanggua', 'v_xihulu'] },
  { id: 'mushroom', name: '菌菇', foodIds: ['v_xianggu', 'v_jinzhen', 'v_xingbaogu', 'v_muer'] },
  { id: 'allium', name: '葱蒜类', foodIds: ['v_yangcong', 'v_suanmiao'] },
  { id: 'legume_veg', name: '豆荚蔬菜', foodIds: ['v_wandou', 'v_doujiao', 'v_jiangdou', 'bn_maodou'] },
  { id: 'citrus', name: '柑橘', foodIds: ['f_chengzi', 'f_youzi', 'f_ningmeng'] },
  { id: 'berry', name: '浆果', foodIds: ['f_lanmei', 'f_caomei', 'f_putao', 'f_yingtao', 'f_sangshen'] },
  { id: 'stone_fruit', name: '核果', foodIds: ['f_taozi', 'f_yingtao', 'f_lizi', 'f_xing', 'f_pipa'] },
  { id: 'tropical_fruit', name: '热带水果', foodIds: ['f_mangguo', 'f_boluo', 'f_yezi', 'f_longyan', 'f_lizhi'] },
  { id: 'poultry', name: '禽肉', foodIds: ['m_jirou', 'm_yarou', 'm_jixin'] },
  { id: 'livestock', name: '畜肉', foodIds: ['m_zhurou', 'm_niurou', 'm_yangrou'] },
  { id: 'egg', name: '蛋类', foodIds: ['m_jidanhuang', 'm_jidanbai', 'm_anchundan', 'm_zhengjidan'] },
  { id: 'liver', name: '肝类', foodIds: ['m_zhugan', 'm_jigan'] },
  { id: 'white_fish', name: '白鱼', foodIds: ['s_xueyu', 's_luyu', 's_bashayu', 's_huanghuayu', 's_daiyu'] },
  { id: 'fish', name: '鱼类', foodIds: ['s_sanwenyu', 's_xueyu', 's_luyu', 's_daiyu', 's_huanghuayu', 's_bashayu'] },
  { id: 'crustacean', name: '甲壳类', foodIds: ['s_xiaren', 's_xiapi', 's_xierou'] },
  { id: 'shellfish', name: '贝类', foodIds: ['s_beike', 's_shanbei'] },
  { id: 'soy', name: '大豆制品', foodIds: ['bn_doufu', 'bn_doujiang', 'bn_maodou'] },
  { id: 'beans', name: '杂豆', foodIds: ['bn_hongdou', 'bn_lvdou', 'bn_heidou', 'bn_yingzuidou', 'bn_yundou'] },
  { id: 'nuts', name: '坚果', foodIds: ['bn_huasheng', 'bn_hetao', 'bn_yaoguo', 'bn_xingren', 'bn_zhimajiang', 'bn_xingrenfen', 'dc_zhimayou'] },
  { id: 'dairy', name: '乳制品', foodIds: ['d_suannai', 'd_nailao', 'd_niunai', 'd_huangyou', 'd_wutangsuannai', 'd_zhishipian', 'dc_peifangnai'] },
  { id: 'wheat', name: '小麦制品', foodIds: ['g_xiaomai', 'g_quanmaimianbao', 'g_mantou', 'g_yimian', 'g_guamian'] },
  { id: 'rice', name: '大米系', foodIds: ['g_mifen', 'g_damizhou', 'g_mifan', 'g_mifentiao', 'g_heimi'] },
  { id: 'water', name: '饮水', foodIds: ['dc_shui', 'dc_wenkaishui', 'dc_liangbaikai'] },
  { id: 'oil', name: '油脂', foodIds: ['dc_fushiyou', 'dc_ganlanyou', 'dc_zhimayou', 'd_huangyou'] },
];
